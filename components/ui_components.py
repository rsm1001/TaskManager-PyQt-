...
def create_shortcuts_tab_ui(parent_window):
    ...
    parent_window.shortcuts_table.setHorizontalHeaderLabels(['名称', '类型', '标签', '路径', '创建日期', 'Terminal'])
    ...
    parent_window.shortcuts_table.horizontalHeader().setSectionResizeMode(3, QHeaderView.ResizeMode.Stretch)
    parent_window.shortcuts_table.horizontalHeader().setSectionResizeMode(4, QHeaderView.ResizeMode.ResizeToContents)
    parent_window.shortcuts_table.horizontalHeader().setSectionResizeMode(5, QHeaderView.ResizeMode.Fixed)
    parent_window.shortcuts_table.horizontalHeader().resizeSection(5, 70)

...
from services.domain.random_task_service import pick_random_todo_task


class TodoTaskOperations:
    """待办事项操作处理器"""
    ...
    def delete_todo_task(self):
        ...
        deleted = self._w.data_manager.delete_todo_tasks_batch(task_ids)
        self._w.load_todo_tasks()
